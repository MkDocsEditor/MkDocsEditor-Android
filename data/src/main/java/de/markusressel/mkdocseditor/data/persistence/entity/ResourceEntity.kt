 ...
 */
@Entity
data class ResourceEntity(@Id var entityId: Long = 0, val type: String = "Resource", val id: String = "", val name: String = "", val filesize: Long = -1L, val modtime: Date = Date()) : IdentifiableListItem {
